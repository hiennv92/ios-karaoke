...
#define kGradientTint       [UIColor yellowColor]
...
-(void) setTextColor:(UIColor *)textColor
{
    ...
    gradientLayer.colors            = [NSArray arrayWithObjects:(id)[_tint CGColor],(id)[self.tint CGColor], (id)[textColor CGColor], nil];
...
- (void)setTint:(UIColor *)tint
{
    ...
    CAGradientLayer *gradientLayer  = (CAGradientLayer *)self.layer;
    gradientLayer.colors            = [NSArray arrayWithObjects:(id)[_tint CGColor],(id)[_tint CGColor], (id)[self.textColor CGColor], nil];
    [self setNeedsDisplay];
}
...
- (void)startAnimating
{
    ...
    if([gradientLayer animationForKey:kAnimationKey] == nil) {
        ...
        [self performSelector:@selector(changeColor) withObject:Nil afterDelay:self.animationDuration * 1.5];
    }
}

- (void)changeColor {
    [self setTextColor:_tint];
}
